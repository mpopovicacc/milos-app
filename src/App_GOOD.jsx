...
{(currentState === 'C' || currentState === 'S') && rCountdown !== null && (
  <div
    className={`countdown-label ${currentState === 'C' 
      ? `c-state-countdown-${image === 'C1.png' ? '1' : image === 'C2.png' ? '2' : image === 'C3.png' ? '3' : '4'}`
      : `s-state-countdown-${image === 'S1.png' ? '1' : image === 'S2.png' ? '2' : image === 'S3.png' ? '3' : '4'}`}`}
  >
    {rCountdown}
  </div>
)}
